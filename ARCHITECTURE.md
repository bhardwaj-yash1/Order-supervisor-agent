...
The database URL is configurable — can be pointed to PostgreSQL for production use.
...
1. **SQLite vs PostgreSQL**: Used SQLite for zero-config setup. The DB URL is configurable for PostgreSQL.
